...
void display(){
    ...
    uniformRegister(MVP,curr_Program,"MVP");
    uniformRegister(View,curr_Program,"View");
    uniformRegister(Model,curr_Program,"Model");
    uniformRegister(Projection,curr_Program,"Projection");

    uniformRegister(ModelViewMatrix,curr_Program,"ModelViewMatrix");
    uniformRegister(NormalMatrix,curr_Program,"NormalMatrix");

    //REGISTRAMOS LOS PARAMETROS DE LA LUZ
    vec4 LightPos0 = View * Lights[0].Position; //OJO EL ULTIMO NUMERO DEBE SER 1.0
    vec4 LightPos1 = View * Lights[1].Position;
    // PORQUE 1.0 EN EL CUARTO VALOR REPRESENTA UNA POSICION EN EL ESPACIO
    // SI FUESE 0.0 REPRESENTARIA UNA DIRECCION
    //printMatrix(View);
    //printf("LightPos(%.3f,%.3f,%.3f)\n",LightPos.x,LightPos.y,LightPos.z );

    uniformRegister(AmbientLight,curr_Program,"AmbientLight");

    uniformRegister(LightPos0,curr_Program,"Lights[0].Position");

    uniformRegister(Lights[0].Ld,curr_Program,"Lights[0].Ld");
    uniformRegister(Lights[0].La,curr_Program,"Lights[0].La");
    uniformRegister(Lights[0].Ls,curr_Program,"Lights[0].Ls");

    uniformRegister(LightPos1,curr_Program,"Lights[1].Position");

    uniformRegister(Lights[1].Ld,curr_Program,"Lights[1].Ld");
    uniformRegister(Lights[1].La,curr_Program,"Lights[1].La");
    uniformRegister(Lights[1].Ls,curr_Program,"Lights[1].Ls");

    uniformRegister(Mats[mySphere].Kd,curr_Program,"Material.Kd");
    uniformRegister(Mats[mySphere].Ks,curr_Program,"Material.Ks");
    uniformRegister(Mats[mySphere].Ka,curr_Program,"Material.Ka");
    uniformRegister(Shininess,curr_Program,"Material.Shininess");

    uniformRegister(Fog.maxDist, curr_Program , "Fog.maxDist");
    uniformRegister(Fog.minDist, curr_Program, "Fog.minDist");
    uniformRegister(Fog.density, curr_Program , "Fog.density");
    ...
    uniformRegister(VP,program3,"VP");
